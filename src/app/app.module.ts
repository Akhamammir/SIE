...
import {Authalog} from './App/Auth/Auth';
...
import {Cats} from './App/Categories/Cat';
import {Client} from './App/Clients/Clnt';
import {Cot} from './App/Cotizations/Cots';
...
import {Compras} from './App/Compras/Comp';
import {ComprasEco} from './App/CompEcosa/CompEco';
import {ComprasG} from './App/Kardex/CompG';
import {Envios} from './App/Envios/Env';
import {Alta} from './App/AltaAdmin/High';
...
const Aroute: Routes =[
  ...
  {path: 'Auth/:id/:Roll', component: Authalog},
  ...
  {path: 'Cat/:id/:Roll', component: Cats},
  {path: 'Clt/:id/:Roll', component: Client},
  {path: 'Cots/:id/:Roll', component: Catalog},
  {path: 'POs/:id/:Roll', component: Pactalog},
  {path: 'New/:id/:Roll', component: Cot},
  {path: 'Edit/:id/:Roll', component: Cot},
  ...
  {path: 'Com/:id/:Roll', component: Compras},
  {path: 'ComE/:id/:Roll', component: Compras},
  ...
  {path: 'High/:id/:Roll', component: Alta},
...
@NgModule({
  declarations: [
     Routing, Login, Main, Users, Provs, Prods, Cats, Client, Cot, Catalog,
      Links, Fac, FactalogComponent, Compras, ComprasG, Envios, EnviosEc, Rols, Alta,
      EnviosEco, Fact, DelvingCli, Delving, CatalogR, Trans, Ticketeer, Ticketup,
      TCatalog, Pactalog, Authalog, ComprasEco, Remmits, CatalogRem,
      LoginFSH, MainFSH
  ],
  imports: [
